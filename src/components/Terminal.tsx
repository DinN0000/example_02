...
export default function Terminal() {
  ...
  return (
    <div className="fixed inset-0 bg-black font-mono flex items-center justify-center p-3">
      {/* 카드 컨테이너 */}
      <div className="w-full h-full max-w-5xl bg-card rounded-2xl border border-border shadow-2xl shadow-black/50 overflow-hidden flex flex-col">
