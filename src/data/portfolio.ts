...
`,
    ...
    highlights: [
      "● 스테이블코인 플랫폼 PO — 규제·금융·블록체인이 교차하는 고복잡도 시장에서 기술 검토·제안을 통해 규제 리스크를 사업 기회로 전환",
      "● AI 전문성 — HCI 석사, AI 논문 3편(서비스 설계·신뢰 회복·포트폴리오 선택) 게재, 조직 내 AI 워크플로우 설계·배포, 개인 AI-PKM 시스템 구축·운영",
      "● End-to-End 오너십 — 아이디어를 Demo로 직접 구현해 필드 검증까지 수행, 출시 지연 제품은 특허 작성으로 내부 자산화",
    ],
  },
