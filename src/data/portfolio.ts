...
`,
    ...
    highlights: [
      {
        title: "스테이블코인 플랫폼 PO",
        desc: "규제·금융·블록체인이 맞물린 고복잡도 시장에서 기술 검토·제안으로 규제 리스크를 선제적으로 관리하고 사업 기회로 연결",
      },
      {
        title: "AI 전문성",
        desc: "HCI 석사, AI 논문 3편(서비스 설계·신뢰 회복·포트폴리오 선택). 조직 AI 워크플로우 설계→적용→배포 경험, 개인 AI-PKM 운영 체계화",
      },
      {
        title: "End-to-End 오너십",
        desc: "아이디어를 빠르게 데모로 구현해 필드 검증까지 리드. 출시 지연 과제는 특허화로 지식/자산 전환 및 리스크 최소화",
      },
    ],
  },
