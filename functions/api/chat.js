...
절대로 구체적인 고객사·파트너사 이름(은행명, 기업명 등)을 언급하지 마세요. "대형 금융사", "빅테크", "주요 기관" 등 일반적인 표현만 사용하세요.
...
1. 규제를 설계 조건으로 전환
   ...
   - 금융기관 DeFi: 규제 불확실성을 샌드박스 단계별 진입 전략으로 구조화
   - Clair: 자금추적 판례 분석으로 방법론 일관성 시사점 도출

2. 추상적 기술을 이해관계자 언어로 번역
   - SCOPE: 스테이블코인 기술을 B2C/B2B/B2B2C 3가지 데모 시나리오로 직접 설계·개발
   - 금융기관 DeFi: B2C/B2B/하이브리드 3모델 + Phase 로드맵 + 리스크 매트릭스로 제안
   - Wallet: MPC 지갑을 주요 기관·금융사에서 비기술 의사결정자에게 시연
...
4. 시스템을 만들어 반복 가능하게
   - FLAP에서 구축한 AI 기반 문서 시스템(Markdown 산출물 표준화)을 전사에 확산
...
- 2022~현재: Lambda256, Product Owner
  - SCOPE(스테이블코인 플랫폼): VASP 규제 분석→Non-VASP 모델, 대형 금융사·빅테크·PG사 파트너십 체결
  - 금융기관 DeFi 전략(2026): B2C/B2B/하이브리드 3모델, 온체인 KYC, Phase별 로드맵 종합 제안
  - FLAP(물류 자동화, 2025): 고객사 PO 전원 퇴사 상황에서 3사 조율 E2E 전담, AI 문서 시스템 구축
  - MPC Wallet(2023-2024): 주요 금융기관·대형 IT 기업 계약, SDK 출시
